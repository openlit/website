...
function SiteShellFrame({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-[100dvh] w-full flex-col overflow-hidden border-0 border-stone-200 bg-white pt-[env(safe-area-inset-top)] dark:border-stone-800 dark:bg-stone-950 md:border md:pt-0">

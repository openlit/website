...
![GenAI Observability dashboard in Oodle](/static/images/oodle-openlit/dashboard.png)
...
For step-by-step setup, including OTel Collector configuration, SDK instrumentation, and the pre-built Grafana dashboard JSON, see the [OpenLIT Oodle destination guide](https://docs.openlit.io/latest/sdk/destinations/oodle).

...
date: '2026-09-19'
lastmod: '2026-09-19'
tags: ['openlit', 'langfuse', 'llm-observability', 'opentelemetry', 'open-source', 'comparison']
draft: false
...
[OpenLIT](https://openlit.io) is an open-source Agent Harness Engineering platform for LLM tracing, evaluations, prompt management, and cost tracking, built on OpenTelemetry and free to self-host under Apache 2.0.
...
Unlike instrumentation-only libraries, OpenLIT is the self-hosted platform _and_ the SDK. See the [OpenLIT overview](https://docs.openlit.io/latest/overview) and [OpenLIT vs Langfuse](/compare/openlit-vs-langfuse).
